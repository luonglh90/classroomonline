...
class ResponseLogin : public ::google::protobuf::Message {
 public:
  ...
  inline ::METRO::CRO::MESSAGES::Enums_ResponseLoginEnums status() const;
  inline void set_status(::METRO::CRO::MESSAGES::Enums_ResponseLoginEnums value);
...
inline ::METRO::CRO::MESSAGES::Enums_ResponseLoginEnums ResponseLogin::status() const {
  // @@protoc_insertion_point(field_get:METRO.CRO.MESSAGES.ResponseLogin.status)
  return static_cast< ::METRO::CRO::MESSAGES::Enums_ResponseLoginEnums >(status_);
}
inline void ResponseLogin::set_status(::METRO::CRO::MESSAGES::Enums_ResponseLoginEnums value) {
  assert(::METRO::CRO::MESSAGES::Enums_ResponseLoginEnums_IsValid(value));
  set_has_status();
  status_ = value;
