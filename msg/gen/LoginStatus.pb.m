...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (self.hasStt) {
    [output writeString:2 value:self.stt];
  }
...
- (SInt32) serializedSize {
  ...
  if (self.hasStt) {
    size_ += computeStringSize(2, self.stt);
  }
...
- (void) storeInDictionary:(NSMutableDictionary *)dictionary {
  ...
  if (self.hasStt) {
    [dictionary setObject: self.stt forKey: @"stt"];
  }
...
- (BOOL) isEqual:(id)other {
  ...
  return
      ...
      (!self.hasStt || [self.stt isEqual:otherMessage.stt]) &&
...
- (NSUInteger) hash {
  ...
  if (self.hasStt) {
    hashCode = hashCode * 31 + [self.stt hash];
  }
